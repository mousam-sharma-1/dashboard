...
DashContentComponent.ɵfac = function DashContentComponent_Factory(t) { return new (t || DashContentComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"])); };
DashContentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashContentComponent, selectors: [["app-dash-content"]], decls: 3, vars: 1, consts: [[1, "main-dash-content"], [1, "custom-flex"], ["class", "card bg-dark text-white custom-card", "style", "width:300px", 4, "ngFor", "ngForOf"], [1, "card", "bg-dark", "text-white", "custom-card", 2, "width", "300px"], ["src", "assets/images/img_avatar1.png", "alt", "Card image", 1, "card-img-top", 2, "width", "100%"], [1, "card-body"], [1, "card-title"], [1, "card-text"], [1, "custom-btn"], [1, "btn", "btn-danger"], ["aria-hidden", "true", 1, "fa", "fa-trash"], [1, "btn", "btn-primary"], ["aria-hidden", "true", 1, "fa", "fa-pencil"]], template: function DashContentComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
